package com.ai.html2pdf.service;
...
public class Html2PdfService {
	...
	public String excute(String pageUrl) throws Exception {
		String outputPath = new StringBuffer("/output/").append(BaseUtils.getDateStr("yyyyMMdd")).append("/pdf/")
				.append(BaseUtils.uuid2()).append(".pdf").toString();
